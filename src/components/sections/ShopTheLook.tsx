        ...
        <section className="bg-[#efefef] py-20 px-6 md:px-[160px] font-sans">
            <div className="mx-auto max-w-[1440px]">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
                    ...
                    {/* Look Image + Hotspots */}
                    <div className="relative w-full md:w-[550px] h-[550px] shrink-0 overflow-hidden">
                    ...
                    {/* Product Details */}
                    <div className="w-full md:w-[350px] shrink-0 flex flex-col items-center text-center overflow-hidden">
